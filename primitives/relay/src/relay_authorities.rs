...
pub struct RelayAuthority<AccountId, Signer, Etp3Balance, BlockNumber> {
	pub account_id: AccountId,
	pub signer: Signer,
	pub stake: Etp3Balance,
	pub term: BlockNumber,
}
impl<AccountId, Signer, Etp3Balance, BlockNumber> PartialEq
	for RelayAuthority<AccountId, Signer, Etp3Balance, BlockNumber>
where
	AccountId: PartialEq,
{
...
impl<AccountId, Signer, Etp3Balance, BlockNumber> PartialEq<AccountId>
	for RelayAuthority<AccountId, Signer, Etp3Balance, BlockNumber>
where
	AccountId: PartialEq,
{
...
pub struct ScheduledAuthoritiesChange<AccountId, Signer, Etp3Balance, BlockNumber> {
	/// The new authorities after the change
	pub next_authorities: Vec<RelayAuthority<AccountId, Signer, Etp3Balance, BlockNumber>>,
