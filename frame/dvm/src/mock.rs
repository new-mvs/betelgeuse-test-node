...
use betelgeuse_evm::{AddressMapping, EnsureAddressTruncated, FeeCalculator};
...
impl betelgeuse_evm::Trait for Test {
...
pub type Balances = betelgeuse_balances::Module<Test, Etp3Instance>;
pub type Ethereum = Module<Test>;
pub type Evm = betelgeuse_evm::Module<Test>;
...
pub fn new_test_ext(accounts_len: usize) -> (Vec<AccountInfo>, sp_io::TestExternalities) {
	...
	betelgeuse_balances::GenesisConfig::<Test, Etp3Instance> { balances }
