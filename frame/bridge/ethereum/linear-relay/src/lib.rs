...
//! # Betelgeuse-ethereum-linear-relay Module
//!
//! Prototype module for bridging in Ethereum pow blockchain, including Mainnet and Ropsten.
//!
//! ## Overview
//!
//! The betelgeuse eth linear relay module itself is a chain relay targeting Ethereum networks to
//! Betelgeuse networks. This module follows the basic linear chain relay design which
...
decl_storage! {
	trait Store for Module<T: Trait> as BetelgeuseEthereumLinearRelay {
