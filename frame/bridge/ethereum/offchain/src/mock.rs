...
// --- betelgeuse ---
use crate::*;
use betelgeuse_ethereum_linear_relay::EthereumNetworkType;
...
pub type EthereumRelay = betelgeuse_ethereum_linear_relay::Module<Test>;

pub type EthOffchain = Module<Test>;

impl_outer_dispatch! {
	pub enum Call for Test where origin: Origin {
		betelgeuse_ethereum_linear_relay::EthereumRelay,
		betelgeuse_ethereum_offchain::EthOffchain,
	}
}
...
impl betelgeuse_ethereum_linear_relay::Trait for Test {
...
impl ExtBuilder {
	...
	pub fn build(self) -> sp_io::TestExternalities {
		...
		betelgeuse_ethereum_linear_relay::GenesisConfig::<Test> {
