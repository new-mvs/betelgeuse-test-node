...
// --- betelgeuse ---
use crate::*;
use betelgeuse_relay_primitives::relay_authorities::Sign as SignT;
...
pub struct Test;
pub struct BetelgeuseMMR;
impl MMR<BlockNumber, H256> for BetelgeuseMMR {
...
impl Trait for Test {
	...
	type BetelgeuseMMR = BetelgeuseMMR;
	type Sign = Sign;
	type OpCodes = ();
