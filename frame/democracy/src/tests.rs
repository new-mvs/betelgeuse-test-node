...
// --- betelgeuse ---
use super::*;
use betelgeuse_balances::Error as BalancesError;
...
impl Filter<Call> for BaseFilter {
	fn filter(call: &Call) -> bool {
		!matches!(
			call,
			&Call::Balances(betelgeuse_balances::Call::set_balance(..))
		)
	}
}
...
type Balances = betelgeuse_balances::Module<Test, Etp3Instance>;
...
fn set_balance_proposal(value: u64) -> Vec<u8> {
	Call::Balances(betelgeuse_balances::Call::set_balance(42, value, 0)).encode()
}
