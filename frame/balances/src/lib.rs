...
// --- betelgeuse ---
use betelgeuse_balances_rpc_runtime_api::RuntimeDispatchInfo;
...
pub trait Subtrait<I: Instance = DefaultInstance>: frame_system::Trait {
	...
	/// The means of stoetp3 the balances of an account.
...
decl_storage! {
	trait Store for Module<T: Trait<I>, I: Instance = DefaultInstance> as BetelgeuseBalances {
...
decl_module! {
		...
		origin: T::Origin
	{
		...
		///   - transfering balances to accounts that did not exist before will cause
