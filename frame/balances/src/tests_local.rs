...
// --- betelgeuse ---
use crate::{self as betelgeuse_balances, tests::*, *};

type Balance = u64;

type Etp3 = Module<Test, Etp3Instance>;
type Dna = Module<Test, DnaInstance>;

type Etp3Error = Error<Test, Etp3Instance>;
...
impl Trait<Etp3Instance> for Test {
...
impl ExtBuilder {
	...
	pub fn build(self) -> sp_io::TestExternalities {
		...
		let mut t = frame_system::GenesisConfig::default()
			.build_storage::<Test>()
			.unwrap();
		GenesisConfig::<Test, Etp3Instance> {
