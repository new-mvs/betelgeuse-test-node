...
/// A set of APIs that betelgeuse-like runtimes must implement.
pub trait RuntimeApiCollection:
	...
	+ betelgeuse_balances_rpc_runtime_api::BalancesApi<Block, AccountId, Balance>
	+ betelgeuse_header_mmr_rpc_runtime_api::HeaderMMRApi<Block, Hash>
	+ betelgeuse_staking_rpc_runtime_api::StakingApi<Block, AccountId, Power>
