...
use betelgeuse_cli::{Configuration, BetelgeuseCli};

impl SubstrateCli for Cli {
	fn impl_name() -> String {
		"Betelgeuse Runtime Module Library".into()
	}
	...
	fn support_url() -> String {
		"https://github.com/betelgeuse-network/betelgeuse-common/issues/new".into()
	}
