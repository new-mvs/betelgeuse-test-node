...
where
	...
	C::Api: betelgeuse_balances_rpc::BalancesRuntimeApi<Block, AccountId, Balance>,
	C::Api: betelgeuse_header_mmr_rpc::HeaderMMRRuntimeApi<Block, Hash>,
	C::Api: betelgeuse_staking_rpc::StakingRuntimeApi<Block, AccountId, Power>,
	...
	B::State: sc_client_api::StateBackend<sp_runtime::traits::HashFor<Block>>,
{
	...
	// --- betelgeuse ---
	use betelgeuse_balances_rpc::{Balances, BalancesApi};
	use betelgeuse_header_mmr_rpc::{HeaderMMR, HeaderMMRApi};
	use betelgeuse_staking_rpc::{Staking, StakingApi};
	use dvm_rpc::{
