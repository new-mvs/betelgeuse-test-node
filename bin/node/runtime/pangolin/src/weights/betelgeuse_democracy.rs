...
impl<T: frame_system::Trait> betelgeuse_democracy::WeightInfo for WeightInfo<T> {
	fn propose() -> Weight {
	...
	fn external_propose_default() -> Weight {
		(4_110_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
	...
	fn cancel_referendum() -> Weight {
		(21_590_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
	...
	fn clear_public_proposals() -> Weight {
		(3_582_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
	}
